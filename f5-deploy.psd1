...
FunctionsToExport = 'Add-ASMtoVirutal', 'Add-DataGroupIp', 'Add-FqdnPoolMember', 
               'Add-LogIllegalRequests', 'Add-VirtualToPolicy', 'Add-VsProfile', 
               'Confirm-AsmTaskCompleted', 'Convert-VirtualtoSplat', 
               ...
               'Remove-F5Stack', 'Remove-SSLClient', 'Remove-SSLServer', 
               'Remove-VCDStack', 'Remove-VsProfile', 'Rollback-VCD', 
               'Start-F5Transaction', 'Stop-F5Transaction', 'Upload-Cert'
