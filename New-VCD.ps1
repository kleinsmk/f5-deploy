...
#>
    ...
    process {
                    ...
                    try { Add-PoolMonitor -PoolName "$vsName" -Name tcp -ErrorAction Stop  | Out-Null
                    ...
                    try { New-VirtualServer -Name "$vsName" -DestinationPort "$vsPort" -DestinationIP "$vsIP" -SourceAddressTranslationType automap `
